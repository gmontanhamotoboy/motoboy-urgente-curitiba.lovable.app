(() => {
    ...
    ((w, version, schemaVersions, maxEventsPerBatch = 50, maxKeepaliveBatchBytes = 50 * 1024, maxReplayBodyBytes = 512 * 1024, maxReplayEventsPerChunk = 100, maxReplayTotalBytes = 5 * 1024 * 1024, maxReplayChunks = 50, maxReplayDurationMs = 10 * 60 * 1e3, replayFlushIntervalMs = 2e3) => {
        ...
        const transmitBatchBody = /* @__PURE__ */ __name((body) => {
            ...
            if (nav.sendBeacon && BlobCtor) {
                try {
                    const ok = nav.sendBeacon(trackUrl, new BlobCtor([body], {
    ...
    })(window, "0.1.2-error-event-hardening", {
        ...
        "lovable.web_vital": 1
    }, 50, 51200, 524288, 100, 5242880, 50, 600000, 2000);
})();